...
## Documents - Deploying the microservice
The microservice users is a laravel project and it will be deployed in following url.
...
```apacheconf
Alias "/api/documents"  "C:/Users/namin/Desktop/usjpub/teamworks/laravel/document_microservice/public/"

<Directory "C:/Users/namin/Desktop/usjpub/teamworks/laravel/document_microservice/public/">
	Options +Indexes +FollowSymLinks +MultiViews
	AllowOverride all
	Require all granted
	allow from all
